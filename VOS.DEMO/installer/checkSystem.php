...
<div id="content" style="width:1000px">
  ...
  <p>In order for your HRM installation to function properly,
  ...
  any are red, please take the necessary steps to fix them.</p>
		...
		<tr>
          ...
          <tr>
            <td class="tdComponent">Write Permissions for "symfony/apps/HRM/config"</td>
...
//<![CDATA[
    ...
    function htAcessDisabled() {
        var element = document.getElementById("htaccess");
        element.innerHTML = "Not enabled! This makes HRM vulnerable to security attacks.";
