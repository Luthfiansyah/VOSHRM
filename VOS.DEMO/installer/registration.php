...
<div style="display: block;" class="wrapper">
    ...
    <p style="margin:5px;">You have successfully installed HRM.</p>
    <div class="wrapper" style="width: 900px;">
        <div class="wrapper_content_div" style="font-family: arial,helvetica,sans-serif;font-size: 14px;">
            <h3 style="float: left;">Contribute to HRM by sending us your usage data</h3> <br>
             <div class="registrationWrapper" style="width: 750px;height: 200px; display: block;overflow: scroll;border: #000 solid thin;padding: 5px;">
                <p  ><span style="font-family: arial,helvetica,sans-seif;"><span>By enabling the <span>heartbeat</span> you allow</span>&nbsp; HRM to </span><span style="font-family: arial,helvetica,sans-serif;"><span style="font-family: arial,helvetica,sans-serif;">collect statistics about </span>usage in order to improve the user experience and performance. This function runs in the background and periodically sends data to the HRM Portal. THE DATA ARE JUST NUMBER TOTALS AND THEY DO NOT INCLUDE ANY PERSONAL INFORMATION.  Heartbeat tracks the number of users around the world and logs the time it takes to run database queries.</span><br /><br /></p>
                <div>Also by enabling Heartbeat you will receive the following:<br /></div>
                <ul>
                    <li>Bug fixes and other patches</li>
                    <li>Upgrades</li>
                    <li>Security updates</li>
                    <li>Other useful information about HRM</li>
                </ul>
            ...
            <?php if (!isset($reqAccept) || !$reqAccept) { ?>
                <ul style=" list-style-type: none; padding-left: 0px;">
                   ...
                   <!--  <li>
                        ...
                        <input type = "checkbox" name="hearbeatSelect" id = "hearbeatSelect"/>
                        <label for = "" style="width: 300px;">I would like to send usage data to HRM</label>
                    </li> -->
                </ul>
            <?php } ?>
        </div>
