...
<div class="modal hide" id="preview" style="width:90%">
  <div class="modal-header">
    <a class="close" data-dismiss="modal">×</a>
...
<div class="modal hide" id="employeeEntitlement" style="width:90%">
  <div class="modal-header">
    <a class="close" data-dismiss="modal">×</a>
...
<!-- Confirmation box for employee entitlement-->
<div class="modal hide" id="bulkAssignWaitDlg" style="width:90%">
  <div class="modal-header">
    <h3><?php echo 'OrangeHRM - ' . __('Updating Entitlement'); ?></h3>
  </div>
  <div class="modal-body">
