			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'person_name')
						@la_display($module, 'person_email')
						@la_display($module, 'person_contact')
						@la_display($module, 'product_type')
						@la_display($module, 'message')
						@la_display($module, 'application_route')
						@la_display($module, 'application_database')
						@la_display($module, 'application_status')
					</div>
				</div>
			</div>
		</div>
