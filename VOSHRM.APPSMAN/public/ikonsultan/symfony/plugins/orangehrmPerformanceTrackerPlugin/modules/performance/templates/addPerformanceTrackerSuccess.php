            ...
            <fieldset>
                ...
                <ol>          
                    ...
                    <li>
                        ...
                        <table id="tbl" border="0" class="">
                            <tbody>
                                <tr>
                                    <td id="td1"  style="font-weight:bold; height: 20px">
                                        <?php echo __("available Reviewers"); ?>
                                    </td>
                                    <td id="td2"></td>
                                    <td id="td3"><span style="font-weight: bold"><?php echo __("added Reviewers"); ?></span><em style="color: #AA4935"> *</em></td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td align="center" style="vertical-align: middle">
                                        ...
                                        <input type="button" value="<?php echo __("Add"). " >"; ?>" class="" id="btnAssignEmployee" name="btnAssignEmployee">
                                        <br><br>
										<input type="button" value="<?php echo "< ".__("Remove"); ?>" class="delete" id="btnRemoveEmployee" name="btnRemoveEmployee">
