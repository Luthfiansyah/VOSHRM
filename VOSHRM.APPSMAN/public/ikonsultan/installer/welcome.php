...
function welcomeSubmit() {
	...
	<div id="content">
		<h2>Welcome to the VOS HRM Setup Wizard</h2>


		<p>This installer creates the VOS HRM database tables and sets the
        configuration files that you need to start.</p>
               <!--  <p>
                    If you already use VOS HRM, consider <a href="../upgrader/web/index.php/">upgrading</a>.
                </p>   -->            
		...
		<h4 id="welcomeLink"><a href="http://www.voshrm.com" target="_blank" tabindex="36">voshrm.com</a></h4>
